...
- Current status: WBS 4 (Ornith 1.5 9B 1GPU×2 + LiteLLM topology) 4.1.1 TARGET 완료 (C1 PASS, C2 PASS).
  - 4.1.1 TARGET C1: **`PASS_C1_128K`** (`EXP-V100-ORN15-9B-LLAMA-F16-TARGET-1GPU2-C1-128K-20260926-002`; TTFT 190.01s, Decode 43.34 tok/s, Batch Wall 202.08s, Peak VRAM GPU0 10,891 MiB / GPU1 10,769 MiB).
  - 4.1.1 TARGET C2: **`PASS_C2_ACTIVE`** (`EXP-V100-ORN15-9B-LLAMA-F16-TARGET-1GPU2-C2-128K-20260926-001`; TTFT 186.45s, Mean Decode 43.51 tok/s, Aggregate Decode 77.40 tok/s, Batch Wall 220.01s, Peak VRAM GPU0 10,893 MiB / GPU1 10,893 MiB; preflight 통과 및 RoutingSettledAdmissionBarrier 통한 듀얼 백엔드 동시 병렬 디코드 완벽 증명).
- Next task: WBS 4.1.2 NGRAM C2 (`EXP-V100-ORN15-9B-LLAMA-F16-NGRAM-1GPU2-C2-128K-20260926-001`) 순차 실행. (4.1.2, 4.1.3, 4.1.4, 4.2.1 C1은 사용자 지침에 따라 SKIP)
