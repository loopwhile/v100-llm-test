...
- Native MTP uses the embedded NextN predictor in the target GGUF; the separately recorded mtp_companion artifact is not injected as --model-draft for this lane.
