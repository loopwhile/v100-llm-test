...
- Current status: WBS 4.1 (Ornith 1.5 9B llama.cpp 1GPU×2 + LiteLLM) 전 레인(TARGET, NGRAM, MTP, MTP_NGRAM) 완료 (C2 PASS).
...
- Next task: WBS 4.2.1 1Cat-vLLM STOCK MTP1 C2 (`EXP-V100-ORN15-9B-1CAT-F16-MTP1-1GPU2-C2-128K-20260926-001`) 순차 실행. (4.2.1 C1은 사용자 지침에 따라 SKIP)
