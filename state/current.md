...
- Supplemental diagnostic D2.1.4B: IN_PROGRESS — same b10775/artifacts/MTP n=4, single CUDA0, reduced context, startup-only; isolates TP2 layer-split/KV placement.
