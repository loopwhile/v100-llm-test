...
- 2.2.2 Ornith 9B STOCK: IN_PROGRESS (001 FAIL_STARTUP [f16]; 002 FAIL_CRASH [tilelang without nvcc]; 003 planned with VLLM_SM70_FLASHQLA_ORIGINAL_PREFILL=0).
- 2.2.3 Ornith 35B STOCK: PENDING RETRY (001 FAIL_STARTUP [block_size 2096 > 2048]; ready for 002 with max-num-batched-tokens 4096).
- 2.2.4 Gemma4 26B STOCK: NOT STARTED (download and execution planned after 2.2.2 and 2.2.3).
- Next planned measured execution: WBS 2.2.2 (attempt 003).
