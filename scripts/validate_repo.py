...
def validate():
 ...
 check(g4.get("planning_ready") is True and g4.get("repository")=="cyankiwi/gemma-4-26B-A4B-it-qat-AWQ-INT4","WBS 2.2.4 Gemma artifact drift")
 check(g4.get("revision")=="18a3c7285c33ee39d3e5e16ee6fb2c18f4955ef9","WBS 2.2.4 Gemma revision drift")
 check(g4.get("path")=="/srv/models/gemma-4-26b-a4b-it-qat-awq-int4" and g4.get("kv_candidates")==["FP16"],"WBS 2.2.4 Gemma local/KV contract drift")
